...
<%
    ...
    ArrayList<PedidosProducto> pedidos = Bd.getListaPedidosPorFecha(fecha1, fecha2);
                    ...
                    <tbody>
                        ...
                        %>        
                            <tr>
                                ...
                                <td class="border round"><a href="productosPorPedido.jsp?id_pedido=<%=pedido.getId_pedido()%>" class="btn btn-warning">Productos</a></td>
                            </tr>
                        <%
                            }
                        %>
